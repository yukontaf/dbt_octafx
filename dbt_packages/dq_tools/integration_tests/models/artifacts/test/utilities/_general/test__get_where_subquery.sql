...
select
    'ref without where' as test_case,
    '{{ result_node | escape }}' as input,
    '{{  dq_tools.__get_where_subquery(test_model, result_node.config) }}' as actual,
    '{{ adapter.get_relation(database=target.database, schema=generate_schema_name("seed"), identifier="data_test__get_where_subquery") }}'
    as expected
...
union all
select
    'ref with where' as test_case,
    '{{ result_node | escape }}' as input,
    '{{  dq_tools.__get_where_subquery(test_model, result_node.config) }}' as actual,
    '(select * from {{ adapter.get_relation(database=target.database, schema=generate_schema_name("seed"), identifier="data_test__get_where_subquery") }} where id = 1) dbt_subquery'
    as expected
...
union all
select
    'ref with where | sql_escape' as test_case,
    '{{ result_node | escape }}' as input,
    '{{  dq_tools.__get_where_subquery(test_model, result_node.config, sql_escape=true) }}'
    as actual,
    '(select * from {{ adapter.get_relation(database=target.database, schema=generate_schema_name("seed"), identifier="data_test__get_where_subquery") }} where id = \'1\') dbt_subquery'
    as expected
...
union all
select
    'ref referencing a package' as test_case,
    '{{ result_node | escape }}' as input,
    '{{  dq_tools.__get_where_subquery(test_model, result_node.config) }}' as actual,
    '(select * from {{ adapter.get_relation(database=target.database, schema=generate_schema_name("seed"), identifier="data_test__get_where_subquery") }} where id = 1) dbt_subquery'
    as expected
...
union all
select
    'source without where' as test_case,
    '{{ result_node | escape }}' as input,
    '{{  dq_tools.__get_where_subquery(test_model, result_node.config) }}' as actual,
...
union all
select
    'source with where' as test_case,
    '{{ result_node | escape }}' as input,
    '{{  dq_tools.__get_where_subquery(test_model, result_node.config) }}' as actual,
    '(select * from {{ source("artifacts_seed", "data_test__get_where_subquery") }} where id = 1) dbt_subquery'
    as expected
