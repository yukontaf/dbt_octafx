{% macro __get_dq_issue_type(test_node) %}
    ...
    {% if test_node.test_metadata is defined and test_node.test_metadata.kwargs.dq_issue_type is defined %}
...
{% macro __auto_dq_issue_type(test_node) %}
    ...
    {% endif %}
    {% if test_name.endswith("_db") %} {% set test_name = test_name[0:-3] %} {% endif %}
