...
with
    ...
    test_result as (
        ...
        select
            *,
            ...
            row_number() over (
                partition by invocation_id, table_name order by no_of_table_columns desc
            ) as table_column_rn
    ...
    pre_final as (
        ...
        select
            ...
            sum(
                case when table_column_rn = 1 then no_of_table_columns else 0 end
            ) as all_columns,
            ...
            avg(no_of_records_scanned)
            * 100.0
            / nullif(avg(no_of_records), 0) as column_record_coverage_pct
        ...
        where
            ...
            and table_name
            not in (select table_name from test_result_w_coverage_exclusion)
