...
{% macro find_downstream_nodes(
  ...
  #}
    ...
    {% set transposed_adjacency_list = dbt_ops.transpose_adjacency_list(
        adjacency_list
    ) %}
    {% set dependency_node_info = dbt_ops.get_node_dependency_from_adjacency_list(
        transposed_adjacency_list, unique_id
    ) %}
