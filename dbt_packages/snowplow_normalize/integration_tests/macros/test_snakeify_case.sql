...
{% macro test_snakeify_case() %}
    ...
    {{
        return(
            adapter.dispatch(
                "test_snakeify_case", "snowplow_normalize_integration_tests"
            )()
        )
    }}
...
{% macro default__test_snakeify_case() %}
    ...
    {% set results_dict = {
        ...
        "camel_multi_word": snowplow_normalize.snakeify_case(
            "helloWorldEarth"
        ),
        "camel_end_with_caps": snowplow_normalize.snakeify_case(
            "helloWorldEARTH"
        ),
        "camel_middle_caps": snowplow_normalize.snakeify_case(
            "helloWORLDEarth"
        ),
        "camel_middle_caps": snowplow_normalize.snakeify_case(
            "helloWORLDEarth"
        ...
        "camel_numbers": snowplow_normalize.snakeify_case(
            "helloWorld23Earth"
        ),
    } %}
