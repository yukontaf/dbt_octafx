...
{% set window_clause = "     partition by source_name, session_id     order by page_view_number     rows between unbounded preceding and unbounded following     " %}
...
with
    pageviews_sessionized as (
        ...
        select *
        from
            {{ ref("segment_web_page_views__sessionized") }}
