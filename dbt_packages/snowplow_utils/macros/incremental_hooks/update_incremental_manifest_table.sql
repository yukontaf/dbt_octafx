...
{% macro update_incremental_manifest_table(
    manifest_table,
    base_events_table,
    models,
    ...
    {{
        return(
            adapter.dispatch("update_incremental_manifest_table", "snowplow_utils")(
...
{% macro default__update_incremental_manifest_table(
    manifest_table, base_events_table, models, session_timestamp
) -%}
...
{% macro postgres__update_incremental_manifest_table(
    ...
    {% if models %}
        ...
        -- this protects against partial backfills causing the last_success to move
        -- back in time.
      ...
      insert into snowplow_models_last_success (
        ...
        where model in (select model from snowplow_models_last_success)
        ;
