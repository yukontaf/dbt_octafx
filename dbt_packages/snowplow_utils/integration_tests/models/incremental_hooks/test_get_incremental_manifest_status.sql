...
#}
{%- set all_models = snowplow_utils.get_incremental_manifest_status(
    ref("data_get_incremental_manifest_status"), ["a", "b", "c"]
) -%}
{%- set partial_models = snowplow_utils.get_incremental_manifest_status(
    ref("data_get_incremental_manifest_status"), ["b", "d"]
) -%}
